...
// Local SVG implementation of the Github brand icon (since brand icons are not in lucide-react v1+)
...
function Navigation() {
    ...
    return (
        ...
        >
            ...
            <div className="flex gap-3 border-l border-white/15 pl-4 ml-1">
                <a
                    href="https://github.com/knguyen1411b/flux"
                    target="_blank"
                ...
                <a
                    href="https://www.npmjs.com/package/@knguyen1411b/flux"
                    target="_blank"
                    rel="noopener noreferrer"
...
// Interactive Hero section with Call-To-Actions
    ...
    return (
        ...
        >
            ...
            <p className="mt-6 text-slate-400 text-lg md:text-xl text-center max-w-xl px-4 leading-relaxed font-medium">
                A performant, lightweight, and frame-rate independent smooth
                scroll library tailored for Next.js & React.
            </p>

            <div className="mt-8 flex flex-wrap gap-4 justify-center">
                <button
                    onClick={() => handleScrollTo("#docs")}
                    className="px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold text-sm rounded-full shadow-lg hover:shadow-purple-500/20 transition cursor-pointer"
                >
                    Get Started
                </button>
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-5 py-3 bg-slate-900 border border-white/10 text-white font-semibold text-sm rounded-full hover:bg-slate-800 hover:text-white transition cursor-pointer"
                >
